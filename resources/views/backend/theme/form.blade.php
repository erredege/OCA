...
@section("content")
    ...
    @endisset
        ...
        Posicion "X" de la tematica:<<input type="text" name="position_X" value="{{$theme->position_X ?? '' }}"></br>
        Posicion "Y" de la tematica:<<input type="text" name="position_Y" value="{{$theme->position_Y ?? '' }}"></br>
        <input type="submit">
        </form>
